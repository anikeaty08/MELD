"""
Test 21 - CIFAR-10 ResNet32, 30 epochs
Needs: pip install torchvision
Run: python test_runs/test_21_resnet32_cifar10_30ep.py
"""
...
print("=" * 60)
print("  TEST 21: CIFAR-10 ResNet32 (50 epochs)")
print("  Proves: dedicated quality benchmark for ResNet32")
print("=" * 60)
...
payload = {
    "test": "test_21_resnet32_cifar10_30ep",
    "status": "PASS",
    "model": "ResNet32",
    "epochs": 50,
...
with open(out / "test_21_resnet32_cifar10_30ep.json", "w", encoding="utf-8") as f:
    json.dump(payload, f, indent=2)
print(f"  Saved: {out / 'test_21_resnet32_cifar10_30ep.json'}")
