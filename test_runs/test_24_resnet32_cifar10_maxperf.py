"""
Test 24 - CIFAR-10 ResNet32 max-performance task-incremental setting
Needs: pip install torchvision
Run: python test_runs/test_24_resnet32_cifar10_maxperf.py
"""
...
from delta.demos.models import IncrementalClassifier, MELDModel, resnet32

print("=" * 60)
print("  TEST 24: CIFAR-10 ResNet32 (Max Performance, 10 epochs)")
print("  Proves: deeper backbone in task-identity + pretrained + replay mode")
print("=" * 60)

backbone = resnet32(pretrained=True)
...
payload = {
    "test": "test_24_resnet32_cifar10_maxperf",
    "status": "PASS",
    "model": "ResNet32",
    "epochs": 10,
    "pretrained_backbone": True,
...
with open(out / "test_24_resnet32_cifar10_maxperf.json", "w", encoding="utf-8") as f:
    json.dump(payload, f, indent=2)
print(f"  Saved: {out / 'test_24_resnet32_cifar10_maxperf.json'}")
