"""
Test 25 - MNIST task-incremental replay benchmark
Needs: pip install torchvision
Run: python test_runs/test_25_mnist_taskid_maxperf.py
"""
...
print("=" * 60)
print("  TEST 25: MNIST (Task-Incremental Max Performance, 8 epochs)")
print("  Proves: replay strategy generalizes to a second image dataset")
print("=" * 60)
...
payload = {
    "test": "test_25_mnist_taskid_maxperf",
    "status": "PASS",
    "epochs": 8,
...
with open(out / "test_25_mnist_taskid_maxperf.json", "w", encoding="utf-8") as f:
    json.dump(payload, f, indent=2)
print(f"  Saved: {out / 'test_25_mnist_taskid_maxperf.json'}")
